...
triggers: ["image first grid layout", "image first", "first grid", "grid layout"]
requires: []
core: false
priority: 20
summary: "Create an image-led grid design system with full-bleed photography, structural guide lines, anchored content blocks, and restrained technical overlays."
---
