...
triggers: ["clean minimal beige light mode", "clean minimal", "minimal beige", "beige light", "light mode"]
requires: []
core: false
priority: 20
summary: "Create a clean minimal beige light-mode design system with warm neutral shells, quiet process grids, restrained accent color, and elegant low-contrast structure."
---
