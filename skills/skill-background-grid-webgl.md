...
triggers: ["background grid webgl", "background grid", "grid webgl", "webgl"]
requires: []
core: false
priority: 20
summary: "Create a perspective WebGL background grid with fading lines, subtle particle haze, slow forward drift, and gentle camera parallax."
---
