...
triggers: ["light mode paper technical", "light mode", "mode paper", "paper technical"]
requires: []
core: false
priority: 20
summary: "Create a light-mode technical design system with warm paper surfaces, dark outer framing, subtle diagonal texture, precise bracketed geometry, and restrained accent signals."
---
