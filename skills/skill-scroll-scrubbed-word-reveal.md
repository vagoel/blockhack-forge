...
triggers: ["scroll scrubbed word reveal", "scroll scrubbed", "scrubbed word", "word reveal"]
requires: []
core: false
priority: 20
summary: Reveal marked-up text word by word as scroll progress advances, while preserving semantic inline links, emphasis, responsive line wrapping, and reduced-motion readability. Use for headlines, quotes, manifestos, product statements, onboarding messages, or editorial passages where scrolling should pace comprehension rather than simulate typing.
---
