...
triggers: ["dark glass clean layout", "dark glass", "glass clean", "clean layout"]
requires: []
core: false
priority: 20
summary: "Create a dark glass layout system with frosted premium shells, clean multi-column workspace structure, floating data cards, and restrained atmospheric depth."
---
