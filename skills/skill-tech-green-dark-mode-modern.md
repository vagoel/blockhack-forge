...
triggers: ["tech green dark mode modern", "tech green", "green dark", "dark mode", "mode modern"]
requires: []
core: false
priority: 20
summary: "Create a modern dark-mode technical design system with matte-black surfaces, emerald signal accents, mono system labeling, framed dashboard cards, and restrained glow."
---
