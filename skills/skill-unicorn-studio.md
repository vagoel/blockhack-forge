---
name: unicorn-studio
triggers: ["unicorn studio", "unicorn"]
requires: []
core: false
priority: 20
summary: Use when embedding and customizing Unicorn Studio interactive animations on the web (embed, responsive sizing, performance, layering with UI, fallbacks).
---
