---
name: tailwindcss
triggers: ["tailwindcss"]
requires: []
core: false
priority: 20
summary: Use when designing/implementing UI with Tailwind CSS (layout, typography, responsive, theming, component patterns). Includes quick recipes and conventions for clean, consistent web design.
---
