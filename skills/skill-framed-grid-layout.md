...
triggers: ["framed grid layout", "framed grid", "grid layout"]
requires: []
core: false
priority: 20
summary: Create minimal framed grid layouts with thin visible boundary lines, L-shaped corner brackets, subtle diagonal line texture, and strict section alignment. Use when asked for clean, neutral, precise, structured, editorial, technical, or guide-border web layouts.
---
