...
triggers: ["agency grid layout minimal", "agency grid", "grid layout", "layout minimal"]
requires: []
core: false
priority: 20
summary: "Create a minimal agency design system with a disciplined editorial grid, oversized typography, quiet uppercase utility labels, restrained image blocks, and subtle structural detail."
---
