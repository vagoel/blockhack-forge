...
triggers: ["nested container clean agency", "nested container", "container clean", "clean agency"]
requires: []
core: false
priority: 20
summary: "Create a clean agency design system built from nested containers, with an outer editorial shell, inset dark feature blocks, rounded premium cards, and restrained accent color."
---
