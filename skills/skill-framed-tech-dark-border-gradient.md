...
triggers: ["framed tech dark border gradient", "framed tech", "tech dark", "dark border", "border gradient"]
requires: []
core: false
priority: 20
summary: "Create a framed dark technical design system with border-gradient shells, asymmetrical grid panels, mono utility labeling, and restrained monochrome atmosphere."
---
