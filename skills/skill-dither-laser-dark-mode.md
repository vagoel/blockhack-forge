...
triggers: ["dither laser dark mode", "dither laser", "laser dark", "dark mode"]
requires: []
core: false
priority: 20
summary: "Create a dark premium design system that combines near-black surfaces, subtle ordered-dither texture, and a thin accent-colored laser atmosphere."
---
