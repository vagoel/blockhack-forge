...
triggers: ["css border gradient", "css border", "border gradient"]
requires: []
core: false
priority: 20
summary: Apply subtle gradient-border treatments for premium web surfaces. Use when cards, pricing panels, nav bars, modals, buttons, or hero surfaces need a refined edge highlight without a loud glow.
---
