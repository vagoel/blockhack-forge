...
triggers: ["webgl landing steering", "webgl landing", "landing steering", "webgl"]
requires: []
core: false
priority: 20
summary: Use when creating or refining WebGL-heavy landing pages and you need to steer toward a specific visual outcome (premium, technical, playful, cinematic) while balancing conversion clarity, performance, and implementation complexity.
---
